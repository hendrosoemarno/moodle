...
// Jika tidak ada data sama sekali, tampilkan info lalu footer.
...
$render_subject_table = function(string $subject, array $subject_records) use ($OUTPUT) {
    ...
    foreach ($subject_records as $record) {
        ...
        // Simpan total & correct untuk kategori (menggunakan nama kategori "terproses" dari view agar header rapi)
